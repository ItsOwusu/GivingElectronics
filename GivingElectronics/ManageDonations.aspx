<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageDonations.aspx.cs" Inherits="GivingElectronics.ManageDonations" %>
            ...
            <div class="col-sm-12">
                <div>
                    <asp:GridView ID="gvManageDonations" runat="server" CaptionAlign="Top"
                        ...
                        EmptyDataText="There Are No Donations" OnRowEditing="gvManageDonations_RowEditing" OnRowDeleting ="gvManageDonations_RowDeleting" OnRowUpdating="gvManageDonations_RowUpdating" OnRowCancelingEdit="gvManageDonations_RowCancelingEdit">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Type of Device">
                                <ItemTemplate>
                                    <asp:Label ID="lblElectronicType" runat="server" Text='<%# Bind("DonationType") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Beneficiery">
                                <ItemTemplate>
                                    <asp:Label ID="lblRecipient" runat="server" Text='<%# Bind("CharityName") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlRecipient" CssClass="form-control" runat="server" DataSourceID="RecipientDataSource" AppendDataBoundItems="true" DataTextField="CharityName" DataValueField="RecipientId">
